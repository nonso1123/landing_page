		...
		>
			<div className="w-full md:w-1/2 space-y-8 ">
				<motion.div
					...
					whileInView="show"
				>
					<div className="group flex items-center gap-2 bg-gray-50 w-fit px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer ">
				...
				>
					...
					<span className="text-blue-600 relative inline-block">
						...
						<span className="absolute -bottom-1.5 left-0 bg-blue-200/60 w-full h-0.5"></span>
					</span>{" "}
