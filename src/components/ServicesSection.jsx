...
const ServicesSection = () => {
	return (
		...
		>
			...
			>
				<motion.div variants={fadeIn("right", 0.4)} className="md:w-1/3 w-full">
					<motion.h2
					...
					<motion.div variants={fadeIn("up", 0.6)} className="space-y-3">
						...
						>
							...
							<span className="text-gray-600">Ux designs content strategy</span>
						</motion.div>
						<motion.div
					...
					<motion.button
						...
						whileTap={{ scale: 0.95 }}
						className="mt-8 bg-indigo-600 text-white px-8 py-3 rounded-full hover:bg-indigo-700 transition-colors cursor-pointer"
					>
						Get Started
					</motion.button>
				</motion.div>
